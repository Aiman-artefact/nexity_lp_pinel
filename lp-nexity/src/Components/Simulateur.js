    ...
    <section id='container_simulateur'>
      ...
      <div className='simulateur_home'>
        <div className='simulateur_header'>
          ...
          <p>Découvrez les avantages à investir aujourd'hui plutôt qu'en 2023 grâce au Pinel.<sup>(2)</sup></p>
...

      {
        ...
        <div className='simulateur_start '>
          <div className='container_fields'>
            ...
            <div className='calcul_field'>
              <p>Défiscalisation sur 12 ans au taux de 2022<sup>(3)</sup></p>
            ...
            <div className='calcul_field'>
              <p>Défiscalisation sur 12 ans au taux de 2023<sup>(3)</sup></p>
              <div className='defiscal'>
            ...
            <div className='calcul_field'>
              <p>En investissant aujourd’hui, j’économise<sup>(3)</sup></p>
